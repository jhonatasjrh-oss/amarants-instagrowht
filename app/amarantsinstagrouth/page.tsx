  ...
  return (
    <>
      ...
      <nav style={{
        ...
        background: navSolid ? 'rgba(10,10,15,0.95)' : 'rgba(10,10,15,0.7)',
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px', height: 68, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div style={{ cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 4 }} onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            <Image src="/Logo_amarantsGroth.png" alt="Amarants" width={0} height={0} sizes="100vw" style={{ width: 'auto', height: '72px', objectFit: 'contain' }} />
            <span style={{
          ...
          <div className="hero-grid" style={{ display: 'flex', alignItems: 'center', gap: 64 }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{
                ...
                color: '#f48fb1', fontSize: 13, fontWeight: 700,
              ...
              {/* H1 */}
              <h1 className="hero-title" style={{ fontSize: 52, fontWeight: 900, lineHeight: 1.1, marginBottom: 24, letterSpacing: -1.5 }}>
              ...
              <div style={{ display: 'flex', gap: 14, flexWrap: 'wrap', marginBottom: 16 }}>
                <button className="btn-primary" style={{ padding: '17px 36px', fontSize: 16, borderRadius: 14, letterSpacing: 1 }}
                  onClick={() => scrollTo('planos')}>
                  COMEÇAR AGORA
                </button>
                <button className="btn-ghost" style={{ padding: '17px 28px', fontSize: 15, borderRadius: 14 }}
                  onClick={() => scrollTo('como-funciona')}>
                  Ver como funciona ↓
                </button>
              </div>
              <p style={{ color: '#64748b', fontSize: 13, marginBottom: 28 }}>Teste o futuro do crescimento no Instagram.</p>
            ...
            {/* ── Image mockup ── */}
            <div style={{ position: 'relative', width: '450px', height: '600px', flexShrink: 0 }}>
              <Image
      ...
      <section style={{ padding: '100px 24px', background: '#0a0a0f' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          <h2 className="section-title" style={{ fontSize: 44, fontWeight: 900, textAlign: 'center', marginBottom: 16, letterSpacing: -1 }}>
            Você posta… mas o Instagram não cresce?
          </h2>
          <p style={{ color: '#94a3b8', textAlign: 'center', fontSize: 17, lineHeight: 1.7, marginBottom: 56, maxWidth: 640, margin: '0 auto 56px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginBottom: 40 }}>
            {[
              ...
              <div key={i} className="card-hover" style={{
                ...
                <p style={{ fontSize: 17, fontWeight: 600, color: '#e2e8f0' }}>{item.texto}</p>
                <div style={{ marginLeft: 'auto', color: item.cor, fontSize: 20, flexShrink: 0 }}>✗</div>
              </div>
            ))}
          </div>

          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 48, padding: '28px 32px', background: 'rgba(255,255,255,0.03)', borderRadius: 16, border: '1px solid rgba(255,255,255,0.06)' }}>
            <p style={{ color: '#94a3b8', fontSize: 16 }}>Enquanto isso, <strong style={{ color: '#f97316' }}>concorrentes crescem todos os dias.</strong></p>
            <p style={{ color: '#94a3b8', fontSize: 16 }}>O problema não é seu conteúdo. O problema é <strong style={{ color: '#e2e8f0' }}>falta de estratégia, consistência e automação.</strong></p>
            <p style={{ color: '#94a3b8', fontSize: 16 }}>E contratar um social media custa entre <strong style={{ color: '#ef4444' }}>R$1.000 e R$3.000 por mês.</strong></p>
            <p style={{ color: '#f48fb1', fontSize: 16, fontWeight: 700, marginTop: 4 }}>✦ Foi exatamente por isso que criamos o Amarants Instagrowht.</p>
          </div>
      ...
      <section style={{ padding: '100px 24px', background: '#0a0a0f' }}>
        <div style={{ maxWidth: 860, margin: '0 auto', textAlign: 'center' }}>
          <h2 className="section-title" style={{ fontSize: 40, fontWeight: 900, letterSpacing: -1, marginBottom: 16 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14, margin: '48px auto', maxWidth: 560, textAlign: 'left' }}>
            {[
              ...
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 14, padding: '14px 20px', background: 'rgba(233,30,140,0.05)', border: '1px solid rgba(233,30,140,0.12)', borderRadius: 12 }}>
                <span style={{ color: '#22c55e', fontSize: 18, flexShrink: 0 }}>✅</span>
                <span style={{ color: '#e2e8f0', fontSize: 15, fontWeight: 500 }}>{item}</span>
              </div>
            ))}
          </div>
      ...
      {/* ─── SOLUÇÃO ─── */}
      <section id="como-funciona" style={{ padding: '100px 24px', background: 'linear-gradient(180deg, #0d0d14 0%, #0a0a0f 100%)' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 72 }}>
            ...
            <h2 className="section-title" style={{ fontSize: 44, fontWeight: 900, letterSpacing: -1, marginBottom: 16 }}>
          ...
          <div className="steps-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
            {[
              ...
              <div key={i} className="card-hover" style={{
                ...
                <div style={{ position: 'absolute', top: 16, right: 20, fontSize: 42, fontWeight: 900, color: '#e91e8c', lineHeight: 1 }}>{step.n}</div>
                <div style={{ fontSize: 32, marginBottom: 14 }}>{step.icon}</div>
                <h3 style={{ fontSize: 16, fontWeight: 800, marginBottom: 8, color: '#f1f5f9', lineHeight: 1.4 }}>{step.titulo}</h3>
      ...
      <section style={{ padding: '100px 24px', background: '#0a0a0f' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 64 }}>
            <h2 className="section-title" style={{ fontSize: 44, fontWeight: 900, letterSpacing: -1, marginBottom: 14 }}>
            ...
            <p style={{ color: '#64748b', fontSize: 16 }}>Sem contratar freelancer. Sem passar horas no Canva. Sem se perguntar o que postar.</p>
          </div>

          <div className="diff-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 18 }}>
            {[
              ...
              <div key={i} className="card-hover" style={{ background: card.grad, border: `1px solid ${card.borda}`, borderRadius: 20, padding: '28px 24px' }}>
                <div style={{ width: 48, height: 48, borderRadius: 14, background: `rgba(${card.icoCor === '#e91e8c' ? '168,85,247' : card.icoCor === '#f97316' ? '249,115,22' : card.icoCor === '#06b6d4' ? '6,182,212' : card.icoCor === '#22c55e' ? '34,197,94' : card.icoCor === '#ec4899' ? '236,72,153' : '59,130,246'},0.15)`, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 24, marginBottom: 16 }}>{card.icon}</div>
                <h3 style={{ fontSize: 16, fontWeight: 800, marginBottom: 8, color: '#f1f5f9' }}>{card.titulo}</h3>
      ...
      <section style={{ padding: '100px 24px', background: '#0a0a0f' }}>
        <div style={{ maxWidth: 780, margin: '0 auto' }}>
          <h2 className="section-title" style={{ fontSize: 38, fontWeight: 900, textAlign: 'center', letterSpacing: -1, marginBottom: 12 }}>
            Por que pagar milhares por algo que agora{' '}
            <span style={{ background: 'linear-gradient(90deg,#e91e8c,#f97316)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
              custa menos de R$4 por dia?
            </span>
          </h2>
          <p style={{ color: '#64748b', textAlign: 'center', fontSize: 15, marginBottom: 48 }}>Você centraliza tudo em uma única plataforma inteligente.</p>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            {[
              ...
              <div key={i} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '20px 28px', background: row.bg, border: `1px solid ${row.borda}`, borderRadius: 14 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  <span style={{ fontSize: 18 }}>{i === 2 ? '✅' : '❌'}</span>
                  <span style={{ fontSize: 15, fontWeight: 600, color: i === 2 ? '#e2e8f0' : '#94a3b8' }}>{row.label}</span>
                </div>
                <span style={{ fontSize: 15, fontWeight: 800, color: row.cor, flexShrink: 0 }}>{row.preco}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ─── AUTORIDADE ─── */}
      <section style={{ padding: '100px 24px', background: 'linear-gradient(135deg, #120820 0%, #0a0a0f 60%, #001020 100%)', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 800, margin: '0 auto', textAlign: 'center', position: 'relative' }}>
          ...
          <p style={{ fontSize: 20, fontWeight: 700, color: '#f48fb1', marginBottom: 56 }}>
          ...
          <div style={{ display: 'flex', gap: 20, justifyContent: 'center', flexWrap: 'wrap', marginBottom: 56 }}>
            {[
              ...
              <div key={i} style={{ padding: '20px 32px', background: item.bg, border: `1px solid ${item.borda}`, borderRadius: 16, flex: '1', minWidth: 200 }}>
                <p style={{ fontSize: 18, fontWeight: 800, color: item.cor, margin: 0 }}>"{item.frase}"</p>
              </div>
            ))}
          </div>

          <p style={{ color: '#94a3b8', fontSize: 16, lineHeight: 1.8, maxWidth: 620, margin: '0 auto' }}>
      ...
      {/* ─── PLANOS ─── */}
      <section id="planos" style={{ padding: '100px 24px', background: 'linear-gradient(180deg, #0d0d14 0%, #0a0a0f 100%)' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            <h2 className="section-title" style={{ fontSize: 44, fontWeight: 900, letterSpacing: -1, marginBottom: 14 }}>
              Escolha como você quer crescer
            </h2>
            <p style={{ color: '#64748b', fontSize: 16, marginBottom: 32 }}>Sem letras miúdas. Cancele quando quiser.</p>
            ...
            <div className="card-hover" style={{
              ...
              <ul style={{ listStyle: 'none', marginBottom: 32 }}>
                {[
                  ...
                  <li key={i} style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12, color: ok ? '#e2e8f0' : '#374151', fontSize: 14 }}>
            ...
            <div className="card-hover" style={{
              ...
              <ul style={{ listStyle: 'none', marginBottom: 32 }}>
                {[
                  ...
                  <li key={i} style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12, color: '#e2e8f0', fontSize: 14 }}>
              ...
              <button className="btn-primary" style={{ width: '100%', padding: '15px', fontSize: 13, borderRadius: 12, letterSpacing: 0.5 }}
      ...
      <section style={{ padding: '100px 24px', background: '#0a0a0f' }}>
        <div style={{ maxWidth: 800, margin: '0 auto' }}>
          <h2 className="section-title" style={{ fontSize: 44, fontWeight: 900, textAlign: 'center', letterSpacing: -1, marginBottom: 56 }}>
            Ainda tem dúvidas?
          </h2>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            {[
              ...
              <div key={i} style={{ background: item.bg, border: `1px solid ${item.borda}`, borderRadius: 18, padding: '28px 32px' }}>
                <p style={{ fontSize: 16, fontWeight: 800, color: item.cor, marginBottom: 10 }}>"{item.objecao}"</p>
                <p style={{ fontSize: 15, color: '#94a3b8', lineHeight: 1.7 }}>{item.resposta}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ─── DEPOIMENTOS ─── */}
      <section id="depoimentos" style={{ padding: '100px 24px', background: '#0a0a0f' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 64 }}>
            <h2 className="section-title" style={{ fontSize: 44, fontWeight: 900, letterSpacing: -1, marginBottom: 12 }}>
              Quem já está crescendo com o Amarants
            </h2>
            <p style={{ color: '#64748b', fontSize: 16 }}>Resultados reais de quem decidiu crescer de forma inteligente.</p>
          </div>

          <div className="testi-grid" style={{ display: 'flex', gap: 20 }}>
            {[
              {
              ...
              <div key={i} className="card-hover" style={{ flex: 1, background: '#111117', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 20, padding: '28px 24px', display: 'flex', flexDirection: 'column' }}>
                {/* Stars */}
                <div style={{ display: 'flex', gap: 3, marginBottom: 16 }}>
                  {'★★★★★'.split('').map((s, j) => <span key={j} style={{ color: '#fbbf24', fontSize: 16 }}>{s}</span>)}
                </div>
                <p style={{ color: '#cbd5e1', fontSize: 15, lineHeight: 1.7, flex: 1, marginBottom: 20 }}>{t.texto}</p>
                {/* Result badge */}
                <div style={{ background: 'rgba(34,197,94,0.1)', border: '1px solid rgba(34,197,94,0.2)', color: '#22c55e', fontSize: 13, fontWeight: 700, padding: '8px 14px', borderRadius: 10, marginBottom: 20, textAlign: 'center' }}>
                  📈 {t.resultado}
                </div>
                {/* Author */}
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
      ...
      {/* ─── FAQ ─── */}
      <section style={{ padding: '100px 24px', background: 'linear-gradient(180deg,#0d0d14,#0a0a0f)' }}>
        <div className="faq-container" style={{ maxWidth: 720, margin: '0 auto', padding: '0 0' }}>
          <h2 className="section-title" style={{ fontSize: 44, fontWeight: 900, textAlign: 'center', letterSpacing: -1, marginBottom: 12 }}>
            Perguntas frequentes
          </h2>
          <p style={{ color: '#64748b', textAlign: 'center', fontSize: 16, marginBottom: 48 }}>Tudo que você precisa saber antes de começar.</p>
            ...
            {faqs.map((faq, i) => (
              <div key={i} style={{
                ...
                <button onClick={() => setFaqAberto(faqAberto === i ? null : i)} style={{
                  ...
                  <span style={{ fontSize: 15, fontWeight: 700, color: '#f1f5f9', textAlign: 'left', lineHeight: 1.4 }}>{faq.q}</span>
                  <span style={{
                    fontSize: 18, color: '#e91e8c', flexShrink: 0, marginLeft: 16,
                    transform: faqAberto === i ? 'rotate(45deg)' : 'rotate(0)', transition: 'transform 0.22s',
                  }}>+</span>
                </button>
                {faqAberto === i && (
                  <div style={{ padding: '0 24px 20px', color: '#94a3b8', fontSize: 14, lineHeight: 1.75 }}>
                    {faq.a}
                  </div>
                )}
              </div>
      ...
      <section style={{ padding: '100px 24px', background: '#0a0a0f' }}>
        <div style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center' }}>
          <p style={{ fontSize: 24, fontWeight: 700, color: '#64748b', marginBottom: 8 }}>
            Seu Instagram pode continuar parado…
          </p>
          <p style={{ fontSize: 28, fontWeight: 900, color: '#fff', marginBottom: 48, letterSpacing: -0.5 }}>
            Ou começar a{' '}
            <span style={{ background: 'linear-gradient(90deg,#e91e8c,#f97316)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
          ...
          <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap', marginBottom: 48 }}>
            {[
              ...
              <div key={i} style={{ padding: '14px 28px', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 999 }}>
                <span style={{ fontSize: 18, fontWeight: 900, color: item.cor }}>{item.frase}</span>
              </div>
            ))}
          </div>

          <p style={{ color: '#e2e8f0', fontSize: 17, fontWeight: 600, lineHeight: 1.7 }}>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center', position: 'relative' }}>
          <div style={{
            ...
            color: '#f48fb1', fontSize: 12, fontWeight: 700, padding: '6px 16px', borderRadius: 999, marginBottom: 28,
          }}>
            ✦ Mais de 2.300 perfis já crescendo
          </div>

          <h2 style={{ fontSize: 44, fontWeight: 900, lineHeight: 1.15, letterSpacing: -1.5, marginBottom: 20 }}>
          ...
          <button className="btn-primary" style={{ padding: '20px 56px', fontSize: 18, borderRadius: 16, letterSpacing: 1, animation: 'pulse-glow 2.5s ease-in-out infinite' }}
            onClick={() => scrollTo('planos')}>
            ASSINAR AGORA
          </button>

          <div style={{ marginTop: 40, display: 'flex', justifyContent: 'center', gap: 32, flexWrap: 'wrap', color: '#475569', fontSize: 13 }}>
      ...
      {/* ─── FOOTER ─── */}
      <footer style={{ background: '#07070d', borderTop: '1px solid rgba(255,255,255,0.05)', padding: '48px 24px 32px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 32, marginBottom: 40 }}>
            ...
            <div style={{ display: 'flex', gap: 48, flexWrap: 'wrap' }}>
              <div>
                <p style={{ color: '#fff', fontWeight: 700, fontSize: 13, marginBottom: 14 }}>Produto</p>
              ...
              <div>
                <p style={{ color: '#fff', fontWeight: 700, fontSize: 13, marginBottom: 14 }}>Legal</p>
